...
namespace Model {
    public static class Importacao {
        public static void BDImportacao () {
            new Cliente ("Rodrigo Moreira", Convert.ToDateTime ("20/12/1993"), "635.787.555-00", 5);
            new Cliente ("Lais Silva", Convert.ToDateTime ("20/08/1995"), "365.478.358-22", 10);
            new Cliente ("Leticia Fagundes", Convert.ToDateTime ("08/07/2000"), "324.784.658-03", 10);
            new Cliente ("Antonio Silva", Convert.ToDateTime ("08/03/1998"), "654.878.965-08", 16);
            new Cliente ("Joaquim Pietro", Convert.ToDateTime ("03/09/1988"), "128.007.389-01", 30);
